...
const generateVibe = (
  ...
  return {
    nickname: username,
    archetype: ARCHETYPES_LIST[seed % ARCHETYPES_LIST.length], // Використовуємо як головний "Типаж"
    superpower: SUPERPOWERS_LIST[seed % SUPERPOWERS_LIST.length], // Використовуємо як "Особливу прикмету"
    stats: {
      threatLevel: threats[seed % threats.length],
      status: statuses[seed % statuses.length],
      location: location || "Невідома локація",
    },
    roast: ROASTS_LIST[seed % ROASTS_LIST.length], // Вирок
    avatar: avatar,
              ...
              <div className="bg-neutral-900 border border-white/10 relative overflow-hidden">
                ...
                <div className="p-2 md:p-8 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
                  ...
                  <div className="md:col-span-2 flex flex-col gap-3">
                    ...
                    {/* Блок Вироку */}
                    <div className="bg-gradient-to-br from-neutral-800 to-neutral-900 border border-white/10 p-5 relative overflow-hidden mt-auto shadow-inner">
                      ...
                      <h2 className="text-xl md:text-2xl font-black text-white mb-2 uppercase leading-none relative z-10">
                        {result.archetype}
                      </h2>
                      <p className="text-xs text-neutral-400 font-mono border-l-2 border-red-500 pl-3 italic relative z-10">
                        {result.roast}
                      </p>
                    </div>
                  </div>
