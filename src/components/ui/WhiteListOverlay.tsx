...
export const WhiteListOverlay = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-xl p-4">
      <div className="relative w-full max-w-md bg-neutral-900 border border-red-900/30 rounded-2xl p-8 shadow-[0_0_50px_rgba(220,38,38,0.2)] overflow-hidden">
        ...
        {!isSubmitted ? (
          <>
            <div className="flex justify-center mb-6">
              <div className="p-4 bg-neutral-800 rounded-full border border-red-900/50 shadow-inner group">
                <Lock className="w-8 h-8 text-red-500 group-hover:animate-pulse" />
              </div>
            </div>

            <h2 className="text-3xl font-black text-center text-white mb-2 uppercase tracking-tighter leading-none">
            ...
            <p className="text-neutral-400 text-center text-sm mb-6 font-mono leading-relaxed">
            ...
            <div className="space-y-3 mb-6 text-xs text-neutral-400 font-mono border-l-2 border-neutral-700 pl-4">
              <p>
            ...
            <form onSubmit={handleSubmit} className="relative">
              <input
                ...
                className="w-full bg-neutral-800 border border-neutral-700 text-white rounded-xl px-4 py-3 pl-4 pr-12 focus:outline-none focus:border-red-500 transition-colors font-mono placeholder:text-neutral-600"
              />
              <button
                type="submit"
                disabled={!nickname}
          ...
          <div className="text-center py-8">
            ...
            <p className="text-neutral-400 text-sm font-mono mb-6 leading-relaxed">
              Якщо ти не збрехав і дійсно закинув на корм — скоро пущу. <br />
              Якщо ні — сиди і чекай до другого пришестя.
            </p>
            <button
              onClick={() => window.location.reload()}
              className="text-xs text-red-500 font-mono hover:text-red-400 uppercase tracking-widest border-b border-red-500/30 pb-1"
            >
              Я зрозумів, оновити
            </button>
          </div>
